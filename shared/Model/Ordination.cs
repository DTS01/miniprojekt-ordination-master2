...
public abstract class Ordination {
    ...
    {
        // Beregn antallet af dage mellem startdato og slutdato inklusive begge dage
        TimeSpan varighed = slutDen.Date.AddDays(1) - startDen.Date;

        // Konverter TimeSpan til antal hele dage
        int antalDage = (int)varighed.TotalDays;
